...
module.exports = {
  name: 'setup-handlers-roles.handler',
  description: 'setup-handlers-roles.handler command',
  data: { name: 'setup-handlers-roles.handler', description: 'setup-handlers-roles.handler command' },
  COMMAND_ENABLED,
