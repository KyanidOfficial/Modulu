...
module.exports = {
  name: 'setup-handlers-dispatcher',
  description: 'setup-handlers-dispatcher command',
  data: { name: 'setup-handlers-dispatcher', description: 'setup-handlers-dispatcher command' },
  COMMAND_ENABLED,
