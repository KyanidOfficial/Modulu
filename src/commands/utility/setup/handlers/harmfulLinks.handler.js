...
module.exports = {
  name: 'setup-handlers-harmfulLinks.handler',
  description: 'setup-handlers-harmfulLinks.handler command',
  data: { name: 'setup-handlers-harmfulLinks.handler', description: 'setup-handlers-harmfulLinks.handler command' },
  COMMAND_ENABLED,
