...
module.exports = {
  name: 'setup-handlers-confirm.handler',
  description: 'setup-handlers-confirm.handler command',
  data: { name: 'setup-handlers-confirm.handler', description: 'setup-handlers-confirm.handler command' },
  COMMAND_ENABLED,
